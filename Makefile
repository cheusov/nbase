...
PROJECTS  =	apply nawk/bin banner basename cat chmod cleantags \
  ...
  lam ln ls m4 mkdep mkdir mkfifo mktemp mv nice nl paste patch pax printenv \
  printf pwd rev rm rmdir rs qsubst sed seq shar shlock shuffle \
